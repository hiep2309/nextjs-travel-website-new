  ...
  return (
    <section className="relative overflow-hidden py-16 text-white sm:py-20 lg:py-28">
      ...
      <div className="relative mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        <motion.div className="rounded-2xl border border-white/20 bg-white/10 p-4 shadow-2xl backdrop-blur-xl sm:p-6 md:p-8 lg:rounded-3xl lg:p-10">
          <div className="grid items-center gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-10">
            ...
            <motion.div>
              ...
              <motion.div className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-7">
...
fs.writeFileSync("components/Features.tsx", content);
